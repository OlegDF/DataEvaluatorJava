...
class SliceTest {
    ...
    void setUp() {
        ...
        points[0] = new SlicePoint(500, 5, new Date(10000));
        points[1] = new SlicePoint(450, 3, new Date(10010));
        points[2] = new SlicePoint(-800, 4, new Date(10030));
        points[3] = new SlicePoint(1000, 20, new Date(10040));
        points[4] = new SlicePoint(500, 2, new Date(10050));
